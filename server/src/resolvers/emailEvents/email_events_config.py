...
email_footer = """
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tbody>
							...
							<tr>
								<td valign="top" align="center"><span style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif; color:#9EB0C9; font-size:10px;">©<a href="https://www.travelingstrategy.com/" target="_blank" style="color:#9EB0C9 !important; text-decoration:none;">TravelingStrategy</a>2020</span></td>
							</tr>
							<tr>
								<td height="50"></td>
							</tr>
